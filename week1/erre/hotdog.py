import math
from decimal import Decimal # idomatic way to handling decimal numbers in python without float
...
drink_cost = drinks * Decimal('13.95') # Use Decimal to avoid floating-point inaccuracies
